    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li><a class="scroll closeonclick" href="#services">سرویس ها</a></li>

                <li><a class="scroll closeonclick" href="#about">درباره ما</a></li>

                <li><a class="scroll closeonclick" href="#home">صفحه اصلی</a></li>
